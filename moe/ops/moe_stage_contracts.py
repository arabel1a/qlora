...
class MoEFusedExpertsInput:
    ...
    # Per-layer MoE LoRA state (vllm_ascend.lora.fused_moe.MoELoRAContext),
    # set by AscendFusedMoEWithLoRA when an adapter wraps this layer; None
    # for non-LoRA layers. Backport of PR #10977.
...
class MoEMlpComputeInput:
    ...
    need_trans: bool = False
    dynamic_eplb: bool = False
    # MoE LoRA routing metadata + per-layer context (backport of PR #10977).
