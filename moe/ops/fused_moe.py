    ...
    def apply(
        ...
        final_hidden_states = moe_comm_method.fused_experts(
            fused_experts_input=build_fused_experts_input(
                ...
                w1_scale=w1_scale,
                w2_scale=w2_scale,
                # MoE LoRA (PR #10977 backport): per-layer context published by
                # AscendFusedMoEWithLoRA.set_mapping; None when no adapter wraps
                # this layer. `layer` here is the FusedMoE module we wrapped.
